...
class BotTrade(object):
    def __init__(self,api,chart,checker,period,startBalance,trading):
        self.list_of_trades=[]
        self.notTraded=[]
        self.api=api
        self.counter=0
        ...
        self.simBalances['BTC']=startBalance

    def Sell(self,definitiveSellOptions,pos):
    ...
    def Buy(self,definitiveBuyOptions,pos):
        counter=0
    ...
    def simBalance(self,pos):
        ...
        for pair in self.pairs:
            ...
            self.ovrValue += self.simBalances[other] * self.chart.history[pair + '_close'].iloc[pos] * \
                             self.chart.history['BTCUSDT_close'].iloc[-1]  # TODO make panda conform
